@echo off
title Nim-Proxy for Codex  v3.6
color 0A
chcp 65001 >nul 2>&1

echo.
echo   ============================================
echo     Codex x SiliconFlow  Protocol Converter  v3.6
echo     Responses API  ---(proxy)--->  Chat Completions
echo     + Web Admin Panel (http://127.0.0.1:8788/)
echo   ============================================
echo.
...
:: Step 2: Check and free port 8787 (proxy)
echo.
echo [*] Checking port 8787 (proxy)...
call :KILL_PORT 8787

:: Step 3: Check and free port 8788 (admin panel)
